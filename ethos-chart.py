...
print('pasa funciones')
#data = df_2015_2020


# In[24]:

## Comentado procesamiento
...
top = top.sort_values('AGE', ascending=False).head(10)   
...
print('antes de plot');
print(top['TERM'].values[0])
s.plot_df(top['TERM'], period);
print('despues de plot');
